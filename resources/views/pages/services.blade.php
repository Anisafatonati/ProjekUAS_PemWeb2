...
<body>
   ...
   <div class="services_section layout_padding">
            <div class="container">
               ...
               <p class="services_text">Join us at Al-Amin Mosque to strengthen our spiritual bonds and 
                  participate in religious activities that benefit ourselves and the surrounding community.</p>
               <div class="services_section_2">
                  <div class="row">
                     <div class="col-md-4">
                        <div><img src="images/Tadarus.png" class="services_img"></div>
                        <div class="btn_main"><a href="#">Tadarus</a></div>
                     </div>
                     <div class="col-md-4">
                        <div><img src="images/Pengajian.png" class="services_img"></div>
                        <div class="btn_main active"><a href="#">Pengajian</a></div>
                     </div>
                     <div class="col-md-4">
                        <div><img src="images/Sholat1.png" class="services_img"></div>
                        <div class="btn_main"><a href="#">Sholat Berjamaah</a></div>
                     </div>
                  </div>
               </div>
            </div>
